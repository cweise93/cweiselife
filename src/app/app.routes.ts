...
export const routes: Routes = [
  ...
  { matcher: contentDetailMatcher('frameworks'), title: 'Framework | cweise.com', loadComponent: () => import('./pages/framework-detail/framework-detail.component').then(m => m.FrameworkDetailComponent) },
